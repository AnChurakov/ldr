...
namespace TraningPortal.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [HttpPost]
        public RedirectResult AddInfoUser(string Firstname, string Lastname, string Patr)
        {
            ...
            if (user.FirstName == null || user.LastName == null || user.Partonymic == null)
            {
                user.FirstName = Firstname;
                user.LastName = Lastname;
                user.Partonymic = Patr;
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            ViewBag.Patr = CurrentUser.Partonymic;
